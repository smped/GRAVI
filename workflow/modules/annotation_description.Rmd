...
```{r plot-example, fig.height=7, fig.cap = paste("*12kb region surrounding", collapseGenes(subset(gtf$gene, gene_id == id)$gene_name), "showing all annotated regions. Given the multiple possible TSS much of the region around thse has been merged into a single region which has the capacity to function as a promoter, along with aany upstream promoters.*")}
