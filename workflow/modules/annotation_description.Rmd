...
if (length(missing_reg_col) > 0) {
  def_reg_cols <- c(
    promoter = "#FF0000", upstream_promoter = "#FF4500", exon = "#7EDD57", 
    intron = "#008000", proximal_intergenic = "#80C0FF", distal_intergenic = "#3030FF",
    gene_body = "#008000'", intergenic = "#3030FF"
  )
