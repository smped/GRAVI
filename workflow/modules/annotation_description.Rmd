...
`r cat(ifelse(region_params$intron, "3. Exons\n4. Introns\n", "3. Gene Body\n"))`
`r cat(ifelse(region_params$proximal == 0, glue("5. Intergenic regions not already assigned as an upstream promoter"), glue("5. Proximal Intergenic\n6. Distal Intergenic (> {region_params$proximal/1e3}kb from a gene)")))`
