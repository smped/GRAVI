...
Using an adjusted p-value (`r motif_adj`) less than `r motif_params$analysis$alpha` to be considered as significant, `r sum(pos_res$adj_p < motif_params$analysis$alpha)` motifs were considered as showing any type of positional bias.
