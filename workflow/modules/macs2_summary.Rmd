...
```{r plot-common-peaks, results = 'hide', fig.height = ifelse(length(treat_levels) <= 3, 9, 6), fig.width = 6, fig.cap="*Number of consensus peaks that overlap the oracle peaks defined in each condition.*"}
