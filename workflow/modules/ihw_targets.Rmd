...
Independent Hypothesis Weighting (IHW) was then used to partition the raw p-values by the detection of the other ChIP targets under investigation in this workflow (`r glue_collapse(other_targets, sep = ", ", last = " and ")`) defined using the consensus peaks detected under any treatment by `macs2 callpeak`
...
merged_results %>% 
  ...
  facet_wrap(~ihw_covariate, ncol = 3) +
