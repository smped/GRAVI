...
```{r plot-ihw-pvals, fig.height= 3 + 3 * (length(levels(merged_results$ihw_covariate)) %% 3), fig.cap = "*P-Value distributions within all final data partitions. The size of each partition is given within each panel.*"}
y <- ggplot_build(
  tibble(
