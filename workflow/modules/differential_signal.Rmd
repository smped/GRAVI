...
cp <- htmltools::em(
  glue(
    ...
    "Only protein coding genes are shown, however all mapped genes will be ",
    "returned in the downloaded csv"
  )
)
fs <- 12
...
```{r add-ihw, eval = metadata(results)$ihw != "none", child = here::here('workflow/modules/_ihw_differential_signal.Rmd')}
```
