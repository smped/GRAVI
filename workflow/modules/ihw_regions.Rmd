...
```{r plot-ihw-pvals, echo = TRUE, fig.height= 4 + 3 * (length(levels(merged_results$ihw_covariate)) %% 3), fig.cap = "*P-Value distributions within all final data partitions. The size of each parition is given within each panel.*"}
