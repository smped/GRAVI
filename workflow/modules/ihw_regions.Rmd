...
Independent Hypothesis Weighting (IHW) was then used to partition the raw p-values for `r target` differential binding by genomic regions defined previously, and estimate weights to apply to each p-value as a divisor.
