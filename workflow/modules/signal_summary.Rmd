...
Peaks which overlapped any blacklisted or greylisted regions were discarded.
...
all_out <- list(
  enrichment = here::here(
    "output", "results", target, glue("{target}_enrichment.tsv")
  ),
  localz = here::here(
