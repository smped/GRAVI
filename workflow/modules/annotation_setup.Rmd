...
region_cols <- c(
  "black", 
  hcl.colors(length(gene_regions) - 1, rev = TRUE, alpha = 0.8)
)
...
```{r plot-feature-by-region, fig.height = 7, eval = !is.null(external_features), echo = !is.null(external_features), fig.cap = "The proportion of the ranges provided as external features which overlap the gene-centric regions defined previously. Regions associated with detected genes are shown as solid colours, whilst those with no information are shown as semi-transparent colours."}
