...
```{r plot-volcano, fig.cap = glue("*Volcano plots for differential expression separated by target binding patterns. Many genes will have multiple target binding regions mapped to them, and may appear inmultiple panels. All DE genes are listed with full bding patterns in the table below.*")}
diff_windows %>% 
