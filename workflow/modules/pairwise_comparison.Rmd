...
tg_mapped %>% 
  ...
  geom_node_text(
    ...
    repel = TRUE, max.overlaps = round(length(tg_mapped) / 4, 0),
  ...
  scale_size_continuous(
    range = c(1, 10), breaks = seq(0, 100, by = 10)
  ) +
...
## extraChIPs::getProfileData. Until this is rectified, manually log-transform
...
htmltools::tagList(
  mclapply(
    ...
    function(x) {
      ...
      plotHFGC(
        grl_to_plot[[x]],
        features = feat_gr, featcol = feature_colours, featsize = length(feat_gr),
