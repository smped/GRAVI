...
```{r plot-both-donut, fig.cap = "Summary of binding across both comparisons incorporating all sites where binding was detected in either copmarison. Regions where binding is changed in either comparisons are exploded."}
all_windows %>% 
  as_tibble() %>% 
