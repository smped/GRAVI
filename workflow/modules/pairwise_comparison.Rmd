...
The genes in each section and intersection in the following Venn Diagram will then be analysed against the complete set of genes mapped to either `r glue_collapse(comps, last = ' or ')` 
...
`r if (plot_network_t1t2) paste("#### Genes Mapped to Both", glue_collapse(comps, last = ' or '))`
