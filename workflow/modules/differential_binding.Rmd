...
db_method <- match.arg(config$comparisons$method, names(desc_method))
```
...
For this case **only**, gene width is used to capture any sampling bias and the Wallenius Non-Central Hypergeometric Distribution is used.
