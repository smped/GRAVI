...
```{r plot-res-by-chromosome, fig.cap = "*Results for differential binding separated by chromosome. Results are scaled by chromosome length and shown as windows / Mb, although the distributions of windows will be unevenly spaced.*"}
merged_results %>% 
  select(status) %>% 
