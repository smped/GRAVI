...
`r comma(min_genes, 1)` and `r comma(max_genes, 1)`.
...
cp <- htmltools::em(
  glue(
    ...
    "significantly enriched (p~adj~ < {enrich_alpha}) amongst the windows showing ",
