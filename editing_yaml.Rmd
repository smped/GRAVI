...
- `bam:` (Default: "data/bam") Alignments should be placed in `data/bam` as advised in section \@ref(alignments), although this can be changed to any other path as desired. 
...
- `blacklist` Should be obtained from [here](https://github.com/Boyle-Lab/Blacklist/tree/master/lists)
- `gtf`: Should ideally be obtained from [Gencode](https://www.gencodegenes.org/)
...
A gradient through al colours provided in the `heatmaps` element will be generated during generation of heatmaps.
