...
A gradient through al colours provided in the `heatmaps` element will be generated dring generation of heatmaps.
...
For enrichment testing, the preferred p-value adjustment method can be specified using any value that match `p.adjust.methods` with an appropriate threshold also set in this section.
