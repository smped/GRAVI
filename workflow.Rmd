...
5. *Intergenic Regions*: are divided into two subsets, neither of which are premitted to overlap any previously defined regions
...
1. A VennDiagram showing the overlap in consensus peaks and whether one or more oracle peaks overlaps the consensus peak. In the case of 4 or more treatments, an UpSet plot[@upsetr] will be produced instead
