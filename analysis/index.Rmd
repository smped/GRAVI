...
here::here("workflow", "rules", "rulegraph.dot") %>%
  ...
  change_node_colour("(site|create|build|differential)", "forestgreen") %>%
  str_replace_all("_", "\n") %>%
...
This effectively makes the first listed group as the treatment and the second listed as the reference of control.
