...
```{r pie-gene-regions, fig.height=8, fig.width=8, fig.cap = "Summary of gene-derived regions using the above workflow and the supplied GTF. Blacklisted regions were not considered for this step of the annotation."}
gene_regions %>% 
  lapply(
    function(x){
